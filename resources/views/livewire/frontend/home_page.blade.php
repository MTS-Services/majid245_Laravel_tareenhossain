...
<section>
    <div>
        ...
        <section class="relative h-screen md:h-[60vh] flex items-center justify-center overflow-hidden">
            <!-- Background Image -->
            <div class="absolute inset-0 z-0 scroll-animate translate-y-8 opacity-0 transition-all duration-700 ease-out">
            ...
            <div class="container relative z-10 px-6 text-white animate-fade-in-up">
                <div>
                    <!-- Main Heading -->
                    <h1 class="font-serif text-4xl md:text-5xl font-bold mb-6 text-white scroll-animate translate-y-8 opacity-0 transition-all duration-700 ease-out">
                        Executive Airport Transfers —
                        <span class="block mt-2 text-white">Covering All of South Yorkshire</span>
                    </h1>

                    <!-- Sub Heading -->
                    <p class="text-lg md:text-xl mb-8 text-white scroll-animate translate-y-8 opacity-0 transition-all duration-700 ease-out">
                        Fixed prices • Flight tracking • 24/7 service
                    </p>

                    <!-- Rating Badge -->
                    <div
                        class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/30 rounded-md px-6 py-3 mb-8 hover:bg-white/20 scroll-animate translate-y-8 opacity-0 transition-all duration-700 ease-out">
                    ...
                    <!-- CTA Buttons -->
                    <div class="flex flex-wrap gap-4 scroll-animate translate-y-8 opacity-0 transition-all duration-700 ease-out">
                        <a href="#booking"
        ...
        <section class="py-9 scroll-mt-[72px]" id="booking">
            <div class="container mx-auto px-5">
                <h2 class="font-serif text-3xl font-bold text-center mb-6 scroll-animate  translate-y-8 opacity-0 transition-all duration-700 ease-out">Book Instantly</h2>
                <p class="text-center text-sm text-gray-600 -mt-1 mb-5 scroll-animate  translate-y-8 opacity-0 transition-all duration-700 ease-out">
                    Search, choose your vehicle/price, then complete details & payment in one flow.
                </p>
                <div class="overflow-visible mt-5 scroll-animate  translate-y-8 opacity-0 transition-all duration-700 ease-out">
                    <div
                        ...
                        <p class="text-center text-gray-700 text-lg">
                            <strong>Booking Form Integration</strong><br>
                            <span class="text-sm">Your iframe booking system would be embedded here</span>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="py-9 bg-bg scroll-mt-[72px]" id="why">
            <div class="container mx-auto px-5">
                <h2 class="font-serif text-3xl font-bold mb-6 scroll-animate opacity-0 translate-y-8 transition-all duration-700 ease-out">
                    Why choose Central Executive Transfers
                </h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    <div
                        class="bg-white border border-gray-200 rounded-2xl p-4 shadow-lg min-h-44 scroll-animate  translate-y-8 hover:shadow-2xl transition-all duration-300! hover:border-second-500 hover:-translate-y-2">
        ...
        <section class="py-9 scroll-mt-[72px]" id="prices">
            <div class="container mx-auto px-5">
                <h2 class="font-serif text-3xl font-bold text-center mb-6 scroll-animate opacity-0 translate-y-8 transition-all duration-700 ease-out">
                    Transparent Airport Prices
                </h2>
                <div class="overflow-x-auto shadow-lg scroll-animate  translate-y-8 rounded-xl opacity-0 transition-all duration-700 ease-out">
        ...
        <section class="py-9 bg-bg scroll-mt-[72px]" id="fleet">
            <div class="container mx-auto px-5">
                <h2 class="font-serif text-3xl font-bold mb-6 scroll-animate  translate-y-8 opacity-0 transition-all duration-300 ease-out">Fleet</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div
                        class="bg-white border border-gray-200 rounded-2xl p-4 shadow-lg min-h-44 scroll-animate  translate-y-8 hover:shadow-2xl transition-all duration-300! hover:border-second-500 hover:-translate-y-2 group">
        ...
        <section class="py-9 scroll-mt-[72px]" id="reviews">
            <div class="container mx-auto px-5">
                <h2 class="font-serif text-3xl font-bold mb-6 scroll-animate  translate-y-8 opacity-0 transition-all duration-300 ease-out">Reviews</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div
                        class="bg-white border border-gray-200 rounded-2xl p-4 shadow-lg min-h-44 scroll-animate  translate-y-8 hover:shadow-2xl transition-all duration-300! hover:border-second-500 hover:-translate-y-2">
                ...
                <p class="text-sm text-gray-600 mt-3 scroll-animate  translate-y-8">
        ...
        <section class="py-9 scroll-mt-[72px]" id="faq">
            <div class="container mx-auto px-5">
                <h2 class="font-serif text-3xl font-bold mb-6 scroll-animate  translate-y-8 opacity-0 transition-all duration-700 ease-out">FAQs</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                    <div
                        class="bg-white border border-gray-200 rounded-2xl p-4 shadow-lg min-h-44 scroll-animate  translate-y-8 hover:shadow-2xl transition-all duration-300! hover:border-second-500 hover:-translate-y-2">
        ...
        <!-- CTA Section -->
        <section class="bg-white text-center py-12 scroll-animate  translate-y-8">
            <div class="container mx-auto px-5">
                ...
                <p>
                    <a class="inline-block px-6 py-4 rounded-lg no-underline font-bold bg-second-500 text-gray-900 transition-all duration-300! hover:-translate-y-1 hover:shadow-2xl shadow-lg"
        ...
        <section class="py-9 bg-second-500 scroll-mt-[72px]" id="contact">
            <div class="container mx-auto px-5">
                <h2 class="font-serif text-3xl font-bold mb-6 text-gray-900 scroll-animate  translate-y-8 opacity-0 transition-all duration-700 ease-out">
                    Contact</h2>
                <div class="scroll-animate translate-y-8 opacity-0 transition-all duration-700 ease-out">
