    ...
    <div>
        <section class="body-font">
            ...
            <section class=" relative h-[60vh] flex items-center justify-center overflow-hidden">
                ...
                <div class="absolute inset-0 z-0 ">
                    ...
                    <div class="absolute inset-0 hero-gradient bg-gradient-to-b from-black/45 to-black/70"></div>
                </div>
                ...
                <div class="container relative z-10  px-6 text-white">
                    <div class="">
                        ...
                        <!-- Sub Heading -->
                        <p class="text-lg md:text-md mb-8 text-white">
                ...
                <div class="overflow-x-auto shadow-lg">
                    <table class="w-full border-collapse bg-white rounded-xl overflow-hidden border border-gray-200">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-gray-50 table-hover">
        ...
        <section class="py-9 bg-bg scroll-mt-[72px]" id="fleet">
            <div class="max-w-6xl mx-auto px-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div class="bg-white border border-gray-200 rounded-2xl p-4 shadow-lg min-h-44">
                        <img class="w-full h-[100px] object-contain rounded-lg mb-2 bg-gray-100"
        ...
        <section class="py-9 scroll-mt-[72px]" id="reviews">
            <div class="max-w-6xl mx-auto px-5">
                ...
                <p class="text-sm text-gray-600 mt-3">See all reviews on <a href="https://g.co/kgs/CQqsY6t"
                        target="_blank" rel="noopener" class="font-bold underline">our Google profile</a>.</p>
            </div>
        </section>
            ...
            <div class="max-w-6xl mx-auto px-5">
                ...
                <p class="text-gray-900">
                    ...
                    <strong>WhatsApp:</strong> <a href="https://wa.me/447405172435" target="_blank" rel="noopener"
                        class="text-gray-900 font-bold underline">Message us</a><br>
                    <strong>Email:</strong> <a href="mailto:admin@centraltravels.co.uk"
                        class="text-gray-900 font-bold underline">admin@centraltravels.co.uk</a>
                </p>
                <p class="text-sm text-gray-900 mt-2">We respond quickly — for urgent bookings, call or WhatsApp.</p>
            </div>
        </section>

        <div class="fixed left-0 right-0 bottom-0 bg-primary p-3 flex gap-3 justify-between z-50">
            <a class="flex-1 text-center px-4 py-3 rounded-lg font-semibold no-underline bg-gray-800 text-white"
                href="tel:+447405172435">Call</a>
            <a class="flex-1 text-center px-4 py-3 rounded-lg font-semibold no-underline text-white"
