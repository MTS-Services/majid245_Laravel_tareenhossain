<section>
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
                <div class="grid md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" placeholder="e.g., Sheffield City Centre"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500">
                    </div>
                    <div>
                        <label class="block text-gray-700 font-semibold mb-2">
                            <i class="fas fa-map-marker-alt text-yellow-600 mr-2"></i>Drop-off Location
                        </label>
                        <input type="text" placeholder="e.g., Manchester Airport"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500">
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        <label class="block text-gray-700 font-semibold mb-2">
                            <i class="fas fa-clock text-yellow-600 mr-2"></i>Time
                        </label>
                        <input type="time"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500">
                    </div>
                ...
                <div class="grid md:grid-cols-2 gap-6 mb-8">
                    <div>
                        <label class="block text-gray-700 font-semibold mb-2">
                            <i class="fas fa-users text-yellow-600 mr-2"></i>Passengers
                        </label>
                        <select
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500">
                    ...
                    <div>
                        <label class="block text-gray-700 font-semibold mb-2">
                            <i class="fas fa-car text-yellow-600 mr-2"></i>Vehicle Type
                        </label>
                        <select
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500">
                            <option>Executive Saloon</option>
                            <option>Executive Estate</option>
                            <option>Luxury MPV</option>
                ...
                <button
                    class="w-full gold-gradient text-black py-4 rounded-lg font-bold text-lg hover:opacity-90 transition">
                    <i class="fas fa-search mr-2"></i>Get Instant Quote
                </button>
            </div>
        </div>
    </section>
    ...
    <section id="pricing" class="py-20 bg-gradient-to-br from-gray-900 to-black text-white">
        <div class="max-w-7xl mx-auto px-4">
            <h2 class="text-4xl md:text-5xl font-bold text-center mb-4 heading-font text-white">Transparent Airport Prices
            </h2>
    ...
    <section id="reviews" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="text-center mt-12">
                <a href="https://www.google.com/search?q=central+executive+transfers" target="_blank"
