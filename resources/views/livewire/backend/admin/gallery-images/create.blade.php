<section>
    <div class="glass bg-white rounded-2xl p-6 mb-6">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-text-black dark:text-text-white">{{ __('Gallery Image Create') }}</h2>
        ...
        <form wire:submit="save">
            <div class="mt-6 space-y-4 grid grid-cols-2 gap-5">
                ...
                <div class="w-full col-span-2">
                    ...
                    @if ($form->image)
                        <div class="mt-4">
                            <p class="text-sm text-gray-600 mb-2">{{ __('Image Preview:') }}</p>
            ...
            <div class="flex items-center justify-end gap-4 mt-6">
                ...
                <x-ui.button class="w-auto! py-2!" type="submit">
                    <span wire:loading.remove wire:target="save"
                        class="text-text-btn-primary group-hover:text-text-btn-secondary">{{ __('Create Gallery Image') }}</span>
