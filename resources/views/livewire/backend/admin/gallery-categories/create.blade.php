<section>
    <div class="glass bg-white rounded-2xl p-6 mb-6">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-bold text-text-black dark:text-text-white">{{ __('Gallery Category Create') }}</h2>
            ...
            <div class="flex items-center justify-end gap-4 mt-6">
                ...
                <x-ui.button class="w-auto! py-2!" type="submit">
                    <span wire:loading.remove wire:target="save"
                        class="text-text-btn-primary group-hover:text-text-btn-secondary">{{ __('Create Gallery Category') }}</span>
